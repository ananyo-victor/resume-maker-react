...
function Summary() {
  return (
    <>
      <main class="mx-auto container bg-blue-500 h-full">
        <div class="flex lg:flex-row flex-col-reverse w-full h-full">

          <div id="SmallScreen_1" class="w-full lg:block hidden max-w-1/2 bg-yellow-500">
            <div class="w-full">
          ...
          <div id="SmallScreen_2" class="w-full max-w-1/2 px-4 bg-red-500 lg:h-full h-1/2 hidden">

            <Preview Name='Strength' Desc='Add your every strength here' />

            <div class="mx-auto h-full flex w-full max-w-[520px] flex-col border-white">

              <div contenteditable="true" name="" value="hi" id="BlankSpaceForStrength"
                class="mx-auto lg:h-[380px] w-full max-w-[500px] rounded-md p-3 bg-white"
            ...
            <div class="mt-6 flex lg:hidden mx-auto">
              <button
                ...
                onclick="OpenScreen()">Pre Written Contents</button>
            </div>
          </div>
